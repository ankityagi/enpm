		...
		<div id="list-message" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="message.creator.label" default="Creator" /></th>
				...
				<g:each in="${messageInstanceList}" status="i" var="messageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${messageInstance.id}">${fieldValue(bean: messageInstance, field: "creator")}</g:link></td>
