	...
	<body>
		...
		<div id="show-message" class="content scaffold-show" role="main">
			...
			<ol class="property-list message">
				...
				<g:if test="${messageInstance?.creator}">
				<li class="fieldcontain">
					<span id="creator-label" class="property-label"><g:message code="message.creator.label" default="Creator" /></span>
					
						<span class="property-value" aria-labelledby="creator-label"><g:link controller="secUser" action="show" id="${messageInstance?.creator?.id}">${messageInstance?.creator?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="from-label" class="property-label"><g:message code="message.from.label" default="From" /></span>
						...
						<span class="property-value" aria-labelledby="from-label"><g:link controller="secUser" action="show" id="${messageInstance?.from?.id}">${messageInstance?.from?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="to-label" class="property-label"><g:message code="message.to.label" default="To" /></span>
						...
						<span class="property-value" aria-labelledby="to-label"><g:link controller="secUser" action="show" id="${messageInstance?.to?.id}">${messageInstance?.to?.encodeAsHTML()}</g:link></span>
