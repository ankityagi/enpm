...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'elms.auth.SecUserSecRole'
grails.plugin.springsecurity.authority.className = 'elms.auth.SecRole'
